    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>Danh sách cấp bậc nghề</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Quản lý Danh sách cấp bậc nghề <small>Danh sách cấp bậc nghề</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Danh sách cấp bậc nghề</span> </div>
                        <div class="actions"> <a href="{{ route('create.career.level') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> Thêm cấp bậc nghề</a> </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="careerLevelDatatableAjax">
                                    <thead>
                                        <tr role="row" class="filter"> 
                                            ...
                                            <td><input type="text" class="form-control" name="career_level" id="career_level" autocomplete="off" placeholder="Cấp bậc nghề"></td>
...
<script>
    ...
    function deleteCareerLevel(id, is_default) {
        ...
        if (is_default == 1) {
            msg = 'Are you sure? You are going to delete default Career Level, all other non default Danh sách cấp bậc nghề will be deleted too!';
        }
        if (confirm(msg)) {

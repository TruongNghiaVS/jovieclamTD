...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'country_id') !!}" id="country_id_div">
        ...
        {!! Form::select('country_id', ['' => 'Chọn Quốc gia']+$countries, old('country_id', (isset($city))? $city->getState()->getCountry('country_id'):$siteSetting->default_country_id), array('class'=>'form-control', 'id'=>'country_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'city') !!}">
        {!! Form::label('city', 'Tỉnh thành', ['class' => 'bold']) !!}

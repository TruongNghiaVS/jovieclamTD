    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>{{__('Degree Types')}}</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Quản lý {{__('Degree Types')}} <small>{{__('Degree Types')}}</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">{{__('Degree Types')}}</span> </div>
                        <div class="actions"> <a href="{{ route('create.degree.type') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> Thêm ngành học</a> </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="degreeTypeDatatableAjax">
                                    <thead>                                        
                                        ...
                                        <tr role="row" class="heading">
                                            <th>{{__('Language')}}</th><th>{{__('Degree')}}</th><th<span>{{__('Degree Type')}}</span>/th><th>{{__('Action')}}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>

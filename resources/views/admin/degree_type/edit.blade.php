    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <a href="{{ route('list.degree.types') }}"<span>{{__('Degree Type')}}</span>/a> <i class="fa fa-circle"></i> </li>
                <li> <span<span>{{__('Edit Degree Type')}}</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->        
        <!-- END PAGE HEADER-->
            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo"> <i class="icon-settings font-red-sunglo"></i> <span class="caption-subject bold uppercase">{{__('Degree Type Form')}}</span> </div>
                    </div>

...
<div class="form-body">
    <h3>Kéo và thả để sắp xếp {{__('Degree Types')}}</h3>
    <div class="form-group">
        {!! Form::select('lang', ['' => __('Select')]+$languages, config('default_lang'), array('class'=>'form-control', 'id'=>'lang', 'onchange'=>'refreshDegreeTypeSortData();')) !!}
    </div>
    <div class="form-group">

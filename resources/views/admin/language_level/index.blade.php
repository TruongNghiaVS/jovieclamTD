    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>{{__('Language Levels')}}</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">{{__('Manage Language Levels')}}<small>{{__('Language Levels')}}</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">{{__('Language Levels')}}</span> </div>
                        <div class="actions"> <a href="{{ route('create.language.level') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> {{__('Add Language Level')}}</a> </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="languageLevelDatatableAjax">
                                    <thead>
                                        <tr role="row" class="filter">
                                            ...
                                            <td><input type="text" class="form-control" name="language_level" id="language_level" autocomplete="off" placeholder="{{__('Language Level')}}"></td>

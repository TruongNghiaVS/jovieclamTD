...
<div class="form-body">
    <h3>Kéo và thả để sắp xếp Loại hình doanh nghiệp</h3>
    {!! Form::select('lang', ['' => __('Select')]+$languages, 'en', array('class'=>'form-control', 'id'=>'lang', 'onchange'=>'refreshOwnershipTypeSortData();')) !!}

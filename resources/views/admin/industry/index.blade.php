...
<div class="page-content-wrapper"> 
    ...
    <div class="page-content"> 
        ...
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Quản lý {{__('Industries')}} <small>{{__('Industries')}}</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">{{__('Industries')}}</span> </div>
                        <div class="actions"> <a href="{{ route('create.industry') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> {{__('Add Industry')}}</a> </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="industryDatatableAjax">
                                    <thead>
                                        <tr role="row" class="filter"> 
                                            ...
                                            <td><input type="text" class="form-control" name="industry" id="industry" autocomplete="off" placeholder="Ngành nghề"></td>

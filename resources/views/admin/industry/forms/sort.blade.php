...
<div class="form-body">
    <h3>Kéo và thả để sắp xếp {{__('Industries')}}</h3>
    {!! Form::select('lang', ['' => __('Select')]+$languages, config('default_lang'), array('class'=>'form-control', 'id'=>'lang', 'onchange'=>'refreshIndustrySortData();')) !!}

                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-md-offset-1">
                                    <button class="add-modal" class="btn btn-primary"
                                        onclick="load_blog_category_add_form ()">Thêm Danh mục</button>
                                </div>
                            </div>
                            <ul class="breadcrumb">
                                <ul class="breadcrumb">
                                    <li><a href="{{ URL::asset('/admin/blog')}}"><i class="fa fa-dashboard"></i> Quản lý</li>
                                    <li class="active"><a href="{{ URL::asset('/admin/blog_category')}}"><i
                                                class="fa fa-file-text-o"></i> Quản lý Danh mục</a></li>
                                </ul>
                            </ul>
                        </div>
                    </section>
                    ...
                    <div class="modal-content">
                        <form method="POST" files="true" action="{{ asset('admin/blog_category/create')}}"
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="submit" value="Đóng" class="btn btn-warning" data-dismiss="modal">
                            </div>
                        </form>
                    </div>
                </div>

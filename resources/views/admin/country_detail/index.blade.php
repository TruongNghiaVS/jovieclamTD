    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>{{__('Country Detail')}}</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">{{__('Manage Country Detail')}} <small>{{__('Country Detail')}}</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">{{__('Country Details')}}</span> </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="countryDetailDatatableAjax">
                                    <thead>
                                        <tr role="row" class="heading">
                                            ...
                                            <th>{{__('Code')}}</th>
                                            <th>{{__('Symbol')}}</th>
                                            <th>{{__('Thousand<br />Separator')}}</th>
                                            <th>{{__('Decimal<br />Separator')}}</th>
                                            <th>{{__('Action')}}</th>
                                        </tr>
                                    </thead>
                                    <tbody>

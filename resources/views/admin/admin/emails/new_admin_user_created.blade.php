                ...
                <tr>
                    <td class="row" valign="top" style="padding-left:12px;padding-right:12px;padding-top:18px;padding-bottom:12px">
                        <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                            <tr>
                                <td class="subtitle" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:22px;font-weight:400;color:#333;padding-bottom:30px;    text-align: left;">{{ $siteSetting->site_name }} "Quản trị viên" đã lập tài khoản cho bạn tại {{ $siteSetting->site_name }} "ADMIN PANEL". Đặt mật khẩu sử dụng link này:<br />
                                    <br>
                                    <a href="{{ $link = url('admin/password/reset').'?email='.urlencode($user->getEmailForPasswordReset()) }}"  style="color: #fff;text-decoration: none;background: #f25a55; padding: 7px 10px;text-align: center;display: inline-block;margin-top: 20px;"> Click vào đây để đặt mật khẩu</a></td>
                            </tr>
                            <tr>

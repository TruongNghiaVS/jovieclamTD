    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>Danh sách Quản trị viên</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Quản lý Quản trị viên <small>Quản trị viên</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Quản trị viên</span> </div>
                        <div class="actions">
                            <a href="{{ route('create.admin.user') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> Thêm Quản trị viên mới</a>
                        </div>
                    </div>

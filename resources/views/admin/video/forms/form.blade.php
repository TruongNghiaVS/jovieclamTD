...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'video_text') !!}">
        {!! Form::label('video_text', 'Nội dung Video', ['class' => 'bold']) !!}
        {!! Form::textarea('video_text', null, array('class'=>'form-control', 'id'=>'video_text', 'placeholder'=>'Nội dung Video', 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'video_text') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'video_link') !!}">
        {!! Form::label('video_link', 'Đường dẫn Video', ['class' => 'bold']) !!}
        {!! Form::text('video_link', null, array('class'=>'form-control', 'id'=>'video_link', 'placeholder'=>'Đường dẫn Video', 'dir'=>$direction)) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'video_id') !!}" id="video_id_div">
        {!! Form::label('video_id', 'Video mặc định', ['class' => 'bold']) !!}

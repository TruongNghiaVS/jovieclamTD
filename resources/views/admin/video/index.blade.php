    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>Danh sách Video </span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Quản lý ngôn ngữ Video <small>Ngôn ngữ Video</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Ngôn ngữ Video</span> </div>
                        <div class="actions"> <a href="{{ route('create.video') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> Thêm ngôn ngữ Video </a> </div>
                    </div>

...
<div class="form-body">
    <h3>Kéo và thả để Sắp xếp kỳ trả lương</h3>
    {!! Form::select('lang', ['' => __('Select')]+$languages, config('default_lang'), array('class'=>'form-control', 'id'=>'lang', 'onchange'=>'refreshSalaryPeriodSortData();')) !!}

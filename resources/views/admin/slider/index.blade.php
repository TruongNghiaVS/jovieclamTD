    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>Danh sách Sliders</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Quản lý Sliders <small>Danh sách Sliders</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        ...
                        <div class="actions"> <a href="{{ route('create.slider') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> Thêm Slider</a> </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="sliderDatatableAjax">
                                    <thead>                                        
                                        ...
                                        <tr role="row" class="heading">
                                            <th>{{__('Language')}}</th><th>Slider</th><th>{{__('Action')}}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>

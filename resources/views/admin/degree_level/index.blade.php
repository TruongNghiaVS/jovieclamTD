    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>{{__('Degrees')}}</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">{{__('Manage Degrees')}} <small>{{__('Degrees')}}</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">{{__('Degrees')}}</span> </div>
                        <div class="actions"> <a href="{{ route('create.degree.level') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> {{__('Add Degree')}}</a> </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="degreeLevelDatatableAjax">
                                    <thead>                                        
                                        ...
                                        <tr role="row" class="heading">
                                            <th>{{__('Language')}}</th><th>{{__('Degree')}}</th><th>{{__('Action')}}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>

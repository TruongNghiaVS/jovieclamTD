...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'native') !!}">
        ...
        {!! Form::text('native', null, array('class'=>'form-control', 'id'=>'native', 'placeholder'=>'Tiếng mẹ đẻ')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'iso_code') !!}">
        ...
        {!! Form::text('iso_code', null, array('class'=>'form-control', 'id'=>'iso_code', 'placeholder'=>'Mã ISO')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_rtl') !!}">
        {!! Form::label('is_rtl', 'Viết phải qua trái?', ['class' => 'bold']) !!}
        <div class="radio-list">
            <?php

<div class="modal-body">
    <div class="form-body">
        ...
        <div class="form-group" id="div_major_subjects">
            ...
            ?>
            {!! Form::select('major_subjects[]', $majorSubjects, $profileEducationMajorSubjectIds, array('class'=>'form-control', 'id'=>'major_subjects', 'multiple'=>'multiple')) !!}
        ...
        <div class="form-group" id="div_state_id">
            ...
            <span id="default_state_education_dd">
                {!! Form::select('state_id', [''=>'Chọn vùng miền'], null, array('class'=>'form-control', 'id'=>'education_state_id')) !!}
            </span>

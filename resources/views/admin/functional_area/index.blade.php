    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>{{__('Functional Areas')}} </span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Quản lý {{__('Functional Area')}} <small>{{__('Functional Areas')}} </small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">{{__('Functional Areas')}} </span> </div>
                        <div class="actions"> <a href="{{ route('create.functional.area') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> Thêm {{__('Functional Area')}}</a> </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="functionalAreaDatatableAjax">
                                    <thead>
                                        <tr role="row" class="filter"> 
                                            ...
                                            <td><input type="text" class="form-control" name="functional_area" id="functional_area" autocomplete="off" placeholder="{{__('Functional Area')}}"></td>

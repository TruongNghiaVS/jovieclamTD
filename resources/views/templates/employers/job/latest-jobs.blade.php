...
@include('templates.employers.includes.inner_page_title', ['page_title'=>__('Danh sách Việc làm')])
@include('flash::message')
@include('templates.employers.includes.inner_top_search')
...
<div class="listpgWraper">
    <div class="container">
        <form action="{{route('job.list')}}" method="get">
            ...
            <div class="row"> 
                @include('templates.employers.includes.job_list_side_bar')

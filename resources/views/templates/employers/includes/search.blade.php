<section class="header-bar">
    <div class="header-bar-bg">
        <div class="swiper slider-hero-banner">
            ...
            'sliders.is_active','sliders.used_for','sliders.slider_image','sliders.slider_image_mobile','sliders.linkImage3'
            ])->sorted()->get();
            @endphp
                ...
                @foreach($sliders as $slider)
                    @if($slider->is_active)
                        ...
                        <div class="swiper-slide p-0">
                            ...
                            <div class="is-pc-sm bg-slider" style="background-image: url({{'slider_images/'.$slider->linkImage3}});"></div>

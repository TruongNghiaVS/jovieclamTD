<div class="section-head">
        ...
        <div class="section-head__right-action" bis_skin_checked="1">
                ...
                <div class="right-action__link-edit"><a a href="javascript:;"  onclick="showProfileActivityModal();"><i class="fa-solid fa-pen"></i>Thêm mới</a></div>
                <div class="right-action__link-edit-mobile"><a a href="javascript:;"  onclick="showProfileActivityModal();"><i class="fa-solid fa-pen"></i></a></div>

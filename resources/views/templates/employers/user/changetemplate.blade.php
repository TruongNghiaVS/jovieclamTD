        ...
        <div class="row">
            ...
            <div class="col-template">
                <div class="tools-schemes show-template" id="show_template">
                    @include('templates.employers.user.templates.template_' .
...
@include('templates.employers.user.templates.modal_suggestions')
@include('templates.employers.user.templates.modal_choose_template')
@include('templates.employers.user.templates.modal_view_cv')

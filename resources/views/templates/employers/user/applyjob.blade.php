...
@include('templates.employers.includes.inner_page_title', ['page_title'=>__('Online Application')])
...
@include('templates.employers.user.inc.modal_tempate_letter_content')

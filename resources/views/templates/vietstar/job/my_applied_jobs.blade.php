                    ...
                    <div class="item-job mb-3">
                        ...
                        <div class="jobinfo">
                            <div class="info" bis_skin_checked="1">
                                ...
                                <!-- companyName Start-->
                                <div class="info-item companyName" bis_skin_checked="1"><a href="https://jobvieclam.com/company/cong-ty-co-phan-incom-sai-gon-9" title="{{$company->name}}">{{$company->name}}</a>
                                </div>
                                <!-- companyName End-->

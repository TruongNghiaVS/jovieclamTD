                    ...
                    <div class="card">
                        <div class="posted-job-tab">
                            ...
                            <div class="tab-content" id="postedJobContent">
                                @include('templates.vietstar.job.job_applications')
                                @include('templates.vietstar.job.job_favorite_applications')
                                @include('templates.vietstar.job.job_interview_applications')
                                @include('templates.vietstar.job.hired_applications')
                                @include('templates.vietstar.job.job_rejected_users',['data-target'=>"#posted-job-5-pane"])
                            </div>
                        </div>
                    </div>
                </div>

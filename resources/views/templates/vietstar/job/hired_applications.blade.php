<div class="tab-pane fade" id="posted-job-4-pane" role="tabpanel" aria-labelledby="posted-job-4" tabindex="0">
    <div class="posted-job-profiles">
        <div class="row">
            @if(isset($job_applications_hired) && count($job_applications_hired))
                @foreach($job_applications_hired as $job_application)
                    @php
                    ...
                    <div class="profile-header">
                        <div class="avata">
                            <img src="{{$user->printUserImage(100, 100)}}" alt="">
                        </div>

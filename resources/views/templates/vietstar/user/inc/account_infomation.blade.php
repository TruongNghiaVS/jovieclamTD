<div class="section-head">
    ...
    <div class="section-head__right-action" bis_skin_checked="1">
        ...
        <div class="right-action__link-edit" ><a data-toggle="modal" data-target="#changepassword"><i class="fa-solid fa-pen"></i>Đổi Mật Khẩu</a></div>
        <div class="right-action__link-edit-mobile"><a data-toggle="modal" data-target="#changepassword"><i class="fa-solid fa-pen"></i></a></div>
    </div>
</div>

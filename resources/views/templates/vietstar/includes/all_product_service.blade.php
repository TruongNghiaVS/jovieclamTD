<section class="all-product-service cb-section">
    <div class="container">
        <h2 class="section-title ">Chúng tôi mang đến trải nghiệm toàn diện<br/>trong lĩnh vực cung ứng nhân sự, cung ứng
            việc làm</h2>
                            ...
                            <div class="item">
                                <div class="image">
                                    <img class="lazy-new" alt="Đăng tin tìm việc"
                                        src="{{ asset('/vietstar/imgs/product-service/guest-post-ads.png') }}"
                                        style="">
                                </div>
                                <div class="caption">
                            ...
                            <div class="item">
                                <div class="image">
                                    <img class="lazy-new" alt="Giới thiệu Ứng Viên"
                                        src="{{ asset('/vietstar/imgs/product-service/i7.png') }}"
                                        style="">
                                </div>
                                <div class="caption">
                            ...
                            <div class="item">
                                <div class="image">
                                    <img class="lazy-new" alt="Đăng tin tuyển dụng"
                                        src="{{ asset('/vietstar/imgs/product-service/responsive.png') }}"
                                        style="">
                                </div>
                                <div class="caption">
                            ...
                            <div class="item">
                                <div class="image">
                                    <img class="lazy-new" alt="Cung ứng nhân sự (Headhunt)"
                                            src="{{ asset('/vietstar/imgs/product-service/i2.png') }}"
                                            style="">
                                </div>
                                <div class="caption">
                            ...
                            <div class="item">
                                <div class="image">
                                    <img class="lazy-new" alt="Targeted Email Marketing"
                                            src="{{ asset('/vietstar/imgs/product-service/i6.png') }}"
                                            style="">
                                </div>
                                <div class="caption">

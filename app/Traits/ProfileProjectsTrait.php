...

{
				  ...
				  <div class="col-md-4" id="project_' . $project->id . '">
                    <div class="project">
                        <div class="act-dropdown dropdown">
                            <button type="button" class="btn btn-dropdown dropdown-toggle" id="dropdownMenuProject_' . $project->id . '"  data-toggle="dropdown" aria-expanded="false">
                                <span class="iconmoon icon-recruiter-dots"></span>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuProject_' . $project->id . '">
                                <a class="dropdown-item" href="javascript:void(0);" onclick="showProfileProjectEditModal(' . $project->id . ');">' . __('Edit') . '</a>
                                <a class="dropdown-item" href="javascript:void(0);" onclick="delete_profile_project(' . $project->id . ');">' . __('Delete') . '</a>
                            </div>
                        ...
                        <div class="caption">
                            ...
                            <p>' . $project->date_start->format('d M, Y') . ' - ' . $date_end . '</p>
        ...
        if (isset($user) && count($user->profileProjects)):
            ...
            foreach ($user->profileProjects as $project):
                ...
                if ($project->is_on_going == 1)
                    ...
                    $date_end = __('Dự án đang thực hiện');
...

    {
        ...
        $returnHTML = view('templates.vietstar.user.forms.project.project_modal')->with('user', $user)->render();
...

    {
        ...
        $returnHTML = view(config('app.THEME_PATH').'.user.forms.project.project_edit_modal')
...

    {
        ...
        $returnHTML = view(config('app.THEME_PATH').'.user.forms.project.project_edit_thanks')->render();

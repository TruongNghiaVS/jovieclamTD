...
class CareerLevelFormRequest extends Request
{
    ...
    {
        return [
            'career_level.required' => 'Nhập Cấp bậc Nghề/ Please enter Career Level.',
            'career_level_id.required_if' => 'Chọn cấp bậc nghề mặc định/ dự phòng/ Please select default/fallback Career Level.',
            'is_default.required' => 'Cấp bậc ngày là mặc định?/ Is this Career Level default?',

...
use App\Http\Requests\Front\ContactJobRequest;
...
class ContactController extends Controller
{
    ...
    {
        $seo = SEO::where('seo.page_title', 'like', 'contact')->first();
        return view(config('app.THEME_PATH').'.contact.contact_page_thanks')->with('seo', $seo);
    }
    ...
    public function emailToFriend($slug)
    {
        ...
        return view(config('app.THEME_PATH').'.contact.email_to_friend_page')->with('job', $job)->with('slug', $slug)->with('seo', $seo);
    }
    ...
    {
        $seo = SEO::where('seo.page_title', 'like', 'email_to_friend')->first();
        return view(config('app.THEME_PATH').'.contact.email_to_friend_page_thanks')->with('seo', $seo);
    }
    ...
    public function reportAbuse($slug)
    {
        ...
        return view(config('app.THEME_PATH').'.contact.report_abuse_page')->with('job', $job)->with('slug', $slug)->with('seo', $seo);
    }
    ...
    {
        $seo = SEO::where('seo.page_title', 'like', 'report_abuse')->first();
        return view(config('app.THEME_PATH').'.contact.report_abuse_page_thanks')->with('seo', $seo);
    }
    ...
    public function reportAbuseCompany($slug)
    {
        ...
        $seo = SEO::where('seo.page_title', 'like', 'report_abuse')->first();
        return view(config('app.THEME_PATH').'.contact.report_abuse_company_page')->with('company', $company)->with('slug', $slug)->with('seo', $seo);
    }
    ...
    {
        $seo = SEO::where('seo.page_title', 'like', 'report_abuse')->first();
        return view(config('app.THEME_PATH').'.contact.report_abuse_company_page_thanks')->with('seo', $seo);
    }

    public function contactJob(ContactJobRequest $request) {
        ContactJob::create($request->all());

        return redirect()->back()->with('success', 'Contact job successfully');
    }

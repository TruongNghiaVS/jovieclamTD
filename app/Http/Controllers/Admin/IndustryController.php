...
class IndustryController extends Controller
{
    ...
    public function storeIndustry(IndustryFormRequest $request)
    {
        ...
        $industry->update();
        flash('Ngành nghề đã được thêm vào!')->success();
    ...
    public function updateIndustry($id, IndustryFormRequest $request)
    {
        ...
        $industry->update();
        flash(__('Industry has been updated!'))->success();
        return \Redirect::route('edit.industry', array($industry->id));
    }
        ...
        return Datatables::of($industries)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.industry', ['id' => $industries->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteIndustry(' . $industries->id . ', ' . $industries->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>
						<li>

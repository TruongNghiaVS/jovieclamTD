...
class JobSkillController extends Controller
{
    ...
    public function storeJobSkill(JobSkillFormRequest $request)
    {
        ...
        $jobSkill->update();
        flash(__('Job Skill has been added!'))->success();
    ...
    public function updateJobSkill($id, JobSkillFormRequest $request)
    {
        ...
        $jobSkill->update();
        flash(__('Job Skill has been updated!'))->success();
        return \Redirect::route('edit.job.skill', array($jobSkill->id));
    }
        ...
        return Datatables::of($jobSkills)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.job.skill', ['id' => $jobSkills->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteJobSkill(' . $jobSkills->id . ', ' . $jobSkills->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>
						<li>

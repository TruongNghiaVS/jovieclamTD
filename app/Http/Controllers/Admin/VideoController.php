...
class VideoController extends Controller
{
    ...
    public function storeVideo(VideoFormRequest $request)
    {
        ...
        $video->update();
        /*         * ************************************ */
        flash(__('Video has been added!'))->success();
    ...
    public function updateVideo($id, VideoFormRequest $request)
    {
        ...
        /*         * ************************************ */
        $video->update();
        flash(__('Video has been updated!'))->success();
        return \Redirect::route('edit.video', array($video->id));
    }
        ...
        return Datatables::of($videos)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.video', ['id' => $videos->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteVideo(' . $videos->id . ', ' . $videos->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>
						<li>

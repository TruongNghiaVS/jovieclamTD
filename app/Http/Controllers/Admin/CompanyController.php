...

{
...

    {
        ...
        flash(__('Company has been added!'))->success();
        ...
        return Datatables::of($companies)
                        ...
                        ->addColumn('action', function ($companies) {
                            ...
                            if ((int) $companies->is_featured == 1) {
                                ...
                                $featuredTxt = __('Make Not Featured');
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						...
						<li>
							...
							<a href="' . route('list.jobs', ['company_id' => $companies->id]) . '" target="_blank"><i class="fa fa-list" aria-hidden="true">'.$jobListing.'</i></a>
						...
						<li>
							...
							<a href="' . route('edit.company', ['id' => $companies->id]) . '"><i class="fa fa-pencil" aria-hidden="true">'.$edit.'</i></a>

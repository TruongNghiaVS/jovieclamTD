...
class JobExperienceController extends Controller
{
    ...
    public function storeJobExperience(JobExperienceFormRequest $request)
    {
        ...
        flash(__('Job Experience has been added!'))->success();
    ...
    public function updateJobExperience($id, JobExperienceFormRequest $request)
    {
        ...
        $jobExperience->update();
        flash('Kinh nghiệm làm việc đã được cập nhật!')->success();
        return \Redirect::route('edit.job.experience', array($jobExperience->id));
    }
        ...
        return Datatables::of($jobExperiences)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.job.experience', ['id' => $jobExperiences->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteJobExperience(' . $jobExperiences->id . ', ' . $jobExperiences->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>
						<li>

...
class JobTitleController extends Controller
{
    ...
    public function storeJobTitle(JobTitleFormRequest $request)
    {
        ...
        $jobTitle->update();
        flash(__('Job Title has been added!'))->success();
    ...
    public function updateJobTitle($id, JobTitleFormRequest $request)
    {
        ...
        $jobTitle->update();
        flash(__('Job Title has been updated!'))->success();
        return \Redirect::route('edit.job.title', array($jobTitle->id));
    }
        ...
        return Datatables::of($jobTitles)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.job.title', ['id' => $jobTitles->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteJobTitle(' . $jobTitles->id . ', ' . $jobTitles->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>
						<li>

...
class GenderController extends Controller
{
    ...
    public function storeGender(GenderFormRequest $request)
    {
        ...
        $gender->update();
        flash(__('Gender has been added!'))->success();
    ...
    public function updateGender($id, GenderFormRequest $request)
    {
        ...
        $gender->update();
        flash(__('Gender has been updated!'))->success();
        return \Redirect::route('edit.gender', array($gender->id));
    }
        ...
        return Datatables::of($genders)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.gender', ['id' => $genders->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteGender(' . $genders->id . ', ' . $genders->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>
						<li>

...
class CityController extends Controller
{
    ...
    public function storeCity(CityFormRequest $request)
    {
        ...
        $city->update();
        /*         * ************************************ */
        flash('Đã thêm mới tỉnh thành!')->success();
    ...
    public function updateCity($id, CityFormRequest $request)
    {
        ...
        /*         * ************************************ */
        $city->update();
        flash(__('City has been updated!'))->success();
        return \Redirect::route('edit.city', array($city->id));
    }
        ...
        return Datatables::of($cities)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.city', ['id' => $cities->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteCity(' . $cities->id . ', ' . $cities->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>
						<li>

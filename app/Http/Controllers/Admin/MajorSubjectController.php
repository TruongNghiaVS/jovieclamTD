...
class MajorSubjectController extends Controller
{
    ...
    public function storeMajorSubject(MajorSubjectFormRequest $request)
    {
        ...
        $majorSubject->update();
        /*         * ************************************ */
        flash('Chuyên ngành has been added!')->success();
        ...
        return Datatables::of($majorSubjects)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.major.subject', ['id' => $majorSubjects->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteMajorSubject(' . $majorSubjects->id . ', ' . $majorSubjects->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>
						<li>

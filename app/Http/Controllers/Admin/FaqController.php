...
class FaqController extends Controller
{
    ...
    public function storeFaq(FaqFormRequest $request)
    {
        ...
        $faq->update();
        flash(__('FAQ has been added!'))->success();
    ...
    public function updateFaq($id, FaqFormRequest $request)
    {
        ...
        $faq->lang = $request->input('lang');
        $faq->update();
        flash(__('FAQ has been updated!'))->success();
        return \Redirect::route('edit.faq', array($faq->id));
    }
        ...
        return Datatables::of($faqs)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.faq', ['id' => $faqs->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="delete_faq(' . $faqs->id . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>																																							
					</ul>
				</div>';
                        })

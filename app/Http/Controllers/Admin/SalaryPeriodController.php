...
class SalaryPeriodController extends Controller
{
    ...
    public function updateSalaryPeriod($id, SalaryPeriodFormRequest $request)
    {
        ...
        $salaryPeriod->update();
        flash('Kỳ trả lương đã được cập nhật!')->success();
        return \Redirect::route('edit.salary.period', array($salaryPeriod->id));
    }
        ...
        return Datatables::of($salaryPeriods)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.salary.period', ['id' => $salaryPeriods->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteSalaryPeriod(' . $salaryPeriods->id . ', ' . $salaryPeriods->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>
						<li>

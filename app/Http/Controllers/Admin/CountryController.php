...
class CountryController extends Controller
{
    ...
    public function storeCountry(CountryFormRequest $request)
    {
        ...
        $country->update();
        flash(__('Country has been added!'))->success();
    ...
    public function updateCountry($id, CountryFormRequest $request)
    {
        ...
        $country->update();
        flash(__('Country has been updated!'))->success();
        return \Redirect::route('edit.country', array($country->id));
    }
        ...
        return Datatables::of($countries)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.country', ['id' => $countries->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteCountry(' . $countries->id . ', ' . $countries->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>
						<li>

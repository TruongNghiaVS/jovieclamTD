...
class MaritalStatusController extends Controller
{
    ...
    public function storeMaritalStatus(MaritalStatusFormRequest $request)
    {
        ...
        /*         * ************************************ */
        flash(__('Marital Status has been added!'))->success();
    ...
    public function updateMaritalStatus($id, MaritalStatusFormRequest $request)
    {
        ...
        /*         * ************************************ */
        $maritalStatus->update();
        flash('Tình trạng hôn nhân đã được cập nhật!')->success();
        return \Redirect::route('edit.marital.status', array($maritalStatus->id));
    }
        ...
        return Datatables::of($maritalStatuses)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.marital.status', ['id' => $maritalStatuses->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteMaritalStatus(' . $maritalStatuses->id . ', ' . $maritalStatuses->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>
						<li>

...
class CountryDetailController extends Controller
{
    ...
    public function storeCountryDetail(CountryDetailFormRequest $request)
    {
        ...
        $countryDetail->save();
        /*         * ************************************ */
        flash(__('Country Detail has been added!'))->success();
    ...
    public function updateCountryDetail($id, CountryDetailFormRequest $request)
    {
        ...
        flash(__('Country Detail has been updated!'))->success();
        return \Redirect::route('edit.country.detail', array($countryDetail->id));
    }
        ...
        return Datatables::of($countryDetails)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.country.detail', ['id' => $countryDetails->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteCountryDetail(' . $countryDetails->id . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>

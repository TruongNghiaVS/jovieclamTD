...
class FunctionalAreaController extends Controller
{
    ...
    public function storeFunctionalArea(FunctionalAreaFormRequest $request)
    {
        ...
        flash(__('Functional Area has been added!'))->success();
    ...
    public function updateFunctionalArea($id, FunctionalAreaFormRequest $request)
    {
        ...
        $functionalArea->update();
        flash(__('Functional Area has been updated!'))->success();
        return \Redirect::route('edit.functional.area', array($functionalArea->id));
    }
        ...
        return Datatables::of($functionalAreas)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.functional.area', ['id' => $functionalAreas->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteFunctionalArea(' . $functionalAreas->id . ', ' . $functionalAreas->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>
						<li>

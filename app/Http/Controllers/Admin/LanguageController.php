...
class LanguageController extends Controller
{
    ...
    public function storeLanguage(LanguageFormRequest $request)
    {
        ...
        /*         * ************************************ */
        flash(__('Language has been added!'))->success();
    ...
    public function updateLanguage($id, LanguageFormRequest $request)
    {
        ...
        /*         * ************************************ */
        $language->update();
        flash(__('Language has been updated!'))->success();
        return \Redirect::route('edit.language', array($language->id));
    }
        ...
        return Datatables::of($languages)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.language', ['id' => $languages->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteLanguage(' . $languages->id . ', ' . $languages->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>
						<li>
							<a href="javascript:void(0);" onclick="makeDefaultLanguage(' . $languages->id . ');" class=""><i class="fa fa-pencil" aria-hidden="true"></i>Đặt mặc định</a>
						</li>
						<li>

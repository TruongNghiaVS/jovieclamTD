...
class CareerLevelController extends Controller
{
    ...
    public function storeCareerLevel(CareerLevelFormRequest $request)
    {
        ...
        $careerLevel->update();
        flash(__('Career Level has been added!'))->success();
    ...
    public function updateCareerLevel($id, CareerLevelFormRequest $request)
    {
        ...
        $careerLevel->update();
        flash(__('Career Level has been updated!'))->success();
        return \Redirect::route('edit.career.level', array($careerLevel->id));
    }
        ...
        return Datatables::of($careerLevels)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="' . route('edit.career.level', ['id' => $careerLevels->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a>
						</li>						
						<li>
							<a href="javascript:void(0);" onclick="deleteCareerLevel(' . $careerLevels->id . ', ' . $careerLevels->is_default . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Xóa</a>
						</li>
						<li>

...
class AjaxController extends Controller
{
    ...
    public function filterDefaultStates(Request $request)
    {
        ...
        $dd = Form::select('state_id', ['' => __('Select state')] + $states, $state_id, array('id' => $new_state_id, 'class' => 'form-control form-select chosen'));
        echo $dd;
    }
    ...
    public function filterDefaultCities(Request $request)
    {
        ...
        $dd = Form::select('city_id', ['' => __('Select city')] + $cities, $city_id, array('id' => 'city_id', 'class' => 'form-control form-select chosen'));
        echo $dd;
    }
    ...
    public function filterLangStates(Request $request)
    {
        ...
        $dd = Form::select('state_id', ['' => __('Select one')] + $states, null, array('id' => 'state_id', 'class' => 'form-control'));
        echo $dd;
    }
    ...
    public function filterLangCities(Request $request)
    {
        ...
        $dd = Form::select('city_id', ['' => 'Chọn Tỉnh/Thành'] + $cities, null, array('id' => 'city_id', 'class' => 'form-control'));
        echo $dd;
    }
    ...
    public function filterStates(Request $request)
    {
        ...
        $new_state_id = $request->input('new_state_id', 'state_id');
        $states = DataArrayHelper::langStatesArray($country_id);
        $dd = Form::select('state_id[]', ['' => __('Chọn vùng miền')] + $states, $state_id, array('id' => $new_state_id, 'class' => 'form-control'));
        echo $dd;
    }
    ...
    public function filterCities(Request $request)
    {
        ...
        $dd = Form::select('city_id[]', ['' => 'Chọn Tỉnh/Thành'] + $cities, $city_id, array('id' => 'city_id', 'class' => 'form-control'));
        echo $dd;
    }

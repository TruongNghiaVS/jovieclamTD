...
class Job extends Model
{
    ...
    const SAME_COMPANY_ADD_YES = 1;
    const SAME_COMPANY_ADD_NO = 0;

    const SALARY_TYPE_RANGE = 1;
    const SALARY_TYPE_FROM = 2;
    const SALARY_TYPE_TO = 3;
    const SALARY_TYPE_NEGOTIABLE = 4;
    ...
    public function Interviews() {
        return $this->hasMany('App\Interview', 'job_id', 'id');
    }
    ...
    public function getStatusInterview($interview_status = null) {
    ...
    public function benefits(){
        return $this->hasMany('App\Benefits', 'job_id', 'id');
    }

    public static function getSalaryTypes(){
        return [
            self::SALARY_TYPE_RANGE => __('Salary Range'),
            self::SALARY_TYPE_FROM => __('Salary From'),
            self::SALARY_TYPE_TO => __('Salary To'),
            self::SALARY_TYPE_NEGOTIABLE => __('Negotiable')
        ];
    }

    public static function getListStatusJob()
    {
        return
        [

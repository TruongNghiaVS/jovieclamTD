    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
                        /** @var \THCLOUD\Console\Kernel $instance */
...
namespace THCLOUD\Services\Auth\TwoFactor { 
    ...
    class Facade {
         ...
         *
         * @param \THCLOUD\Services\Auth\TwoFactor\TwoFactorAuthenticatable $user
         * @return bool 
         * @static 
         */ 
        public static function isEnabled($user)
        {
                        /** @var \THCLOUD\Services\Auth\TwoFactor\Authy $instance */
         ...
         *
         * @param \THCLOUD\Services\Auth\TwoFactor\Contracts\Authenticatable $user
         * @return mixed 
         * @static 
         */ 
    ...
    class JWTAuth {
        ...
        public static function attempt($credentials)
        {
            //Method inherited from \Tymon\JWTAuth\JWTAuth            
                        /** @var \THCLOUD\Services\Auth\Api\JWTAuth $instance */
         ...
         *
         * @param bool $forceForever
         * @return \THCLOUD\Services\Auth\Api\JWTAuth 
         * @static 
         */ 
...
namespace  { 
    ...
    class Authy extends \THCLOUD\Services\Auth\TwoFactor\Facade {}
